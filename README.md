...
\* When embedding the 137 icons 3 times the transferred data increased from 22 to 56kB and when using 6 timess the transferred data increased from 22 to 111kB.
...
Loading 137 SVG Icons from the [google Material design library](https://github.com/google/material-design-icons/) with different strategies.
